...
namespace OnlyOddNumbersInLinkedList
{
    /// <summary>
    ///  Bir bağlı listede bulunan sayılardan çift olanları eleyen ve sadece tek sayıları bırakan program. filter fonksiyonu.
    /// </summary>
    ...
    public class LinkedList
    {
        ...
        public void filter()
        {
            ...
            {
                if (curr.value % 2 == 0 && curr == head)
                    head = curr.next;
                else if(curr.next.value % 2 == 0)
                {
