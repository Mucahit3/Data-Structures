...
namespace LinkedListToLinkedListWithIndexNumber
{
    /// <summary>
    ///  Bir bağlı liste ve bir sayıyı parametre alarak, bağlı listeden istenen sayıdaki elemanı yeni bir bağlı liste olarak döndüren fonksiyon.
    ///  filter fonksiyonu.
    /// </summary>
    ...
    public class LinkedList
    {
        ...
        public LinkedList filter(int num)
        {
